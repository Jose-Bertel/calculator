...
<section class="flex justify-center gap-10 p-8 items-center">
  ...
  <section class="flex justify-center gap-10 px-8 py-4 items-start">
    <div class="bg-white shadow-lg rounded-xl p-6 space-y-4 w-96">
      <div class="form-control">
        <label class="label">Estatura (en cm)</label>
        <input id="height" type="number" placeholder="Estatura" class="input input-bordered" />
      </div>
      <div class="form-control">
    ...
    <div class="text-center">
      <h2 class="text-3xl font-bold text-gray-800">Tu resultado:</h2>
      <p id="imc-result" class="text-5xl font-bold my-4 text-gray-600">--</p>
      <p id="imc-advice" class="text-sm text-gray-500">Realiza calculo para ver el rango en el que te encuentras</p>
    </div>
  </section>
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const resultDisplay = document.getElementById("imc-result");
    const adviceDisplay = document.getElementById("imc-advice");
    ...
    calculateBtn.addEventListener("click", () => {
      ...
      if (!heightCm || !weightKg || heightCm <= 0 || weightKg <= 0) {
        ...
        adviceDisplay.textContent = "Por favor ingresa valores válidos.";
        return;
      }
      ...
      resultDisplay.textContent = imcRounded;
      ...
      adviceDisplay.textContent = `Estás en: ${category}`;
    });
  });
</script>
